...
import { X, Calendar, DollarSign, Clock, User, Phone, Mail, Loader2 } from "lucide-react";
import { combineDurationMinutes, formatDuration } from "@/lib/duration";
...
export default function BookAppointmentModal({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (totalMinutes <= 0) {
      setError("Appointment duration must be greater than 0 minutes.");
      setSubmitting(false);
      return;
    }
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-[11px] font-medium text-slate-500">
                  {combineDurationMinutes(durationHours, durationMinutes) > 0 ? (
                    <span className="text-blue-600 font-semibold">{formatDuration(combineDurationMinutes(durationHours, durationMinutes))}</span>
                  ) : (
